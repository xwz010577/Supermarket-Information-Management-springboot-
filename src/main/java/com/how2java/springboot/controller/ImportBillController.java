...
import com.how2java.springboot.service.ImportBillService;
import com.how2java.springboot.service.MerchBillService;
...
public class ImportBillController {
	...
	/*跳转进货信息编辑界面*/
	@RequestMapping(value="/toupdateimport",method=RequestMethod.GET)
	public String  toupdateImportBill(String  imortbillid,Model model){
		importbill importbill=this.importBillService.selectByPrimaryKey(imortbillid);
		model.addAttribute("importb", importbill);
